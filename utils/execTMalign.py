...
def main():
    ...
    structure_dir = "../pdbData/pdb/SwissProt"

    target_file = f"../pdbData/pdb/SwissProt/{args.queryfile}.cif"

    output_file = f"../benchmarkData/SwissProt/tmalign/{args.queryfile}.result"
...
def exec_tmalign_SwissProt():
    ...
    for basename in basenames:
        target_file = f"../pdbData/pdb/SwissProt/{basename}"
        output_file = f"../benchmarkData/SwissProt/tmalign/{basename}.result"

        compare_with_target(structure_dir, target_file, output_file)



def exec_tmalign_SCOPe40():

    structure_dir = "../pdbData/pdb/SCOPe40"
    ...
    for basename in basenames:
        target_file = f"../pdbData/pdb/SCOPe40/{basename}"
        output_file = f"../benchmarkData/SCOPe40/tmalign/{basename}.result"

        compare_with_target(structure_dir, target_file, output_file)


if __name__ == "__main__":
    exec_tmalign_SwissProt()
    exec_tmalign_SCOPe40()
