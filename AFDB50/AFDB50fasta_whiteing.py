...
if __name__ == "__main__":
    file_paths = [f"../models/SSAlignDB/AFDB50/split_fasta_{i}_vector.fasta" for i in range(1, 41)]
    print(file_paths)

    # 设置文件路径
    mu_filename = "../models/SSAlignDB/AFDB50/AFDB50_whitening_mu.npy"
    W_filename = "../models/SSAlignDB/AFDB50/AFDB50_whitening_W.npy"
    ...
    # 例如 处理 .fasta 文件并进行白化变换
    input_file = "../models/SSAlignDB/AFDB50/split_fasta_1_vector.fasta"
    output_file = "../models/SSAlignDB/AFDB50/split_fasta_1_vector_whitend.fasta"
