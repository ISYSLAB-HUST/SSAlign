...
if __name__ == "__main__":
    ...
    mu_filename = "/pdbData/foldseek_database/sp_cif_file/sp_whitening_mu"
    W_filename = "/pdbData/foldseek_database/sp_cif_file/sp_whitening_W"

    processor = WhiteningModel(vector_index, batch_size, mu_filename, W_filename)

    # 文件路径
    input_file = '/pdbData/foldseek_database/sp_cif_file/swissprot_cif_v4_files_results'
    output_file = '/pdbData/foldseek_database/sp_cif_file/swissprot_cif_v4_files_results_whitening'
