...
def more_gtalign_ssalign_foldseek_faiss(basenames,dim,end,step,mode,measure,cos_threshold):
    ...
    if mode == "method_measure":
        # 
        all_only_ssalign_first = all_only_ssalign[all_only_ssalign['Cosine_Similarity'] >= cos_threshold] # 
        all_only_ssalign_second = all_only_ssalign[all_only_ssalign['Cosine_Similarity'] < cos_threshold]  # 
       
        all_only_ssalign_first_sorted = all_only_ssalign_first.sort_values(by='Cosine_Similarity',ascending=False)  # 
        ...
        all_only_foldseek_sorted = all_only_foldseek.sort_values(by='E-value', ascending=True)  # E-value 
